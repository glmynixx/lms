...
<head>
  ...
  <title>Law - Leverage Money Smartly</title>
...
<body>
  ...
  <script>
    const modules = [
      {
        title: "Week 1 - Introduction to Law",
        desc: `A course that explores the basic principles, sources, and functions of law, including how laws are made, interpreted, and applied in society. It provides an overview of legal systems, rights, and responsibilities`,
        video: "Law-Module-Week-1-Introduction-to-Law.pdf",
        pdf: "Law-Module-Week-1-Introduction-to-Law.pdf",
        quiz: [
      ...
      {
        title: "Week 2 - Legal Systems and Classifications",
        desc: `Examines different legal systems, their structures, and how laws are categorized and applied`,
        video: "Law-Module-Week-2-Legal-Systems-and-Classifications.pdf",
        pdf: "Law-Module-Week-2-Legal-Systems-and-Classifications.pdf",
        quiz: [
          { q: "Which of the following is a cyber attack?", a: "a", opt: {a: "Phishing", b: "Gardening", c: "Jogging"} }
        ]
      },
      {
        title: "Week 3 - Rights, Duties, and Legal Personality",
        desc: `Explores the concepts of legal rights and duties, and how they govern relationships in society. It also examines legal personality, including who or what can hold rights and obligations under the law`,
        video: "Law-Module-Week-3-Rights-Duties-and-Legal-Personality.pdf",
        pdf: "Law-Module-Week-3-Rights-Duties-and-Legal-Personality.pdf",
        quiz: [
          { q: "What device filters network traffic?", a: "a", opt: {a: "Firewall", b: "Mouse", c: "Monitor"} }
        ]
      },
      {
        title: "Week 4 - Contract Law and Obligations",
        desc: `Studies the principles of contracts, including how agreements are formed, interpreted, and enforced. It also examines the rights and duties that arise from contractual and other legal obligations`,
        video: "Law-Module-Week-4-Contract-Law-and-Obligations.pdf",
        pdf: "Law-Module-Week-4-Contract-Law-and-Obligations.pdf",
        quiz: [
          { q: "Encryption helps to?", a: "b", opt: {a: "Delete files", b: "Secure data", c: "Share data publicly"} }
        ]
      },
      {
        title: "Week 5 - Criminal Law ",
        desc: `Examines the nature and elements of crimes, including the legal definitions and classifications of criminal acts. It also explores the principles of criminal responsibility, defenses, and the enforcement of criminal laws`,
        video: "Law-Module-Week-5-Introduction-to-Criminal-Law.pdf",
        pdf: "Law-Module-Week-5-Introduction-to-Criminal-Law.pdf",		
        quiz: [
