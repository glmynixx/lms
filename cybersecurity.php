...
<head>
  ...
  <title>Cybersecurity - Leverage Money Smartly</title>
...
<body>
  ...
  <main class="course-container">
    <section class="course-info">
      <h1>Cybersecurity</h1>
      <p>Learn to protect computer systems and networks from cyber threats.</p>
    </section>
    ...
    const modules = [
      {
        ...
        desc: "Provides an overview of cybersecurity, its importance, and its role in protecting digital information and systems.",
        video: "Cybersecurity-Module-Week-1-Introduction-to-Cybersecurity.pdf",
        pdf: "Cybersecurity-Module-Week-1-Introduction-to-Cybersecurity.pdf",
        quiz: [
      ...
      {
        title: "Week 2 - Types of Cybersecurity",
        desc: "Explores different areas of cybersecurity, such as network security, information security, application security, cloud security, and endpoint security.",
        video: "Cybersecurity-Module-Week-2-Types-of-Cybersecurity.pdf",
        pdf: "Cybersecurity-Module-Week-2-Types-of-Cybersecurity.pdf",
        quiz: [
          { q: "Which of the following is a cyber attack?", a: "a", opt: {a: "Phishing", b: "Gardening", c: "Jogging"} }
        ]
      },
      {
        title: "Week 3 - Cybersecurity Threats and Attacks",
        desc: "Examines common cyber threats and attacks, including malware, phishing, denial of service, password attacks, and insider threats.",
        video: "Cybersecurity-Module-Week-3-Cybersecurity-Threats-and-Attacks.pdf",
        pdf: "Cybersecurity-Module-Week-3-Cybersecurity-Threats-and-Attacks.pdf",
        quiz: [
          { q: "What device filters network traffic?", a: "a", opt: {a: "Firewall", b: "Mouse", c: "Monitor"} }
        ]
      },
      {
        title: "Week 4 - Cybersecurity Best Practices",
        desc: "Teaches strategies and measures to prevent, detect, and respond to cyber threats effectively.",
        video: "Cybersecurity-Module-Week-4-Cybersecurity-Best-Practices.pdf",
        pdf: "Cybersecurity-Module-Week-4-Cybersecurity-Best-Practices.pdf",
        quiz: [
          { q: "Encryption helps to?", a: "b", opt: {a: "Delete files", b: "Secure data", c: "Share data publicly"} }
        ]
      },
      {
        title: "Week 5 - Cybersecurity Careers and Emerging Trends",
        desc: "Discusses career paths in cybersecurity and highlights the latest developments and trends in the field.",
        video: "Cybersecurity-Module-Week-5-Cybersecurity-Careers-and-Emerging-Trends.pdf",
        pdf: "Cybersecurity-Module-Week-5-Cybersecurity-Careers-and-Emerging-Trends.pdf",
        quiz: [
